...
function Sidebar() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m8 3 4 8 5-5 5 15H2L8 3z"/></svg>
    },
    {
    ...
    },
    {
      ...
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>
    },
    {
    ...
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <div className="social-links">
          ...
          <a href="https://github.com/harishm17" target="_blank" rel="noopener noreferrer" title="GitHub" aria-label="GitHub">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="mailto:harish_manoharan@outlook.com" title="Email" aria-label="Email">
