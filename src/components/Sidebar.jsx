    ...
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          ...
          <p className="tagline">AI Engineer | Full-Stack Developer</p>
        </div>
        ...
        <div className="social-links">
          ...
          <a href="https://github.com/harishm17" target="_blank" rel="noopener noreferrer" title="GitHub">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="mailto:harish.manoharan@utdallas.edu" title="Email">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
