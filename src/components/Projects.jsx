  ...
  const projects = [
    {
      ...
      points: [
        "Built an AI exam-prep platform that converts course materials into topic-structured notes, quizzes, and graded practice exams using a multi-stage RAG pipeline with semantic chunking and hybrid retrieval",
        "Implemented a real-time voice coach using WebRTC + OpenAI Realtime with tool-driven drills, concept-only guardrails, automated scoring, and latency/quality telemetry and achieved p95 time-to-first-audio of 600 ms",
        "Deployed on GCP (Cloud Run/Cloud Tasks) with GitHub Actions CI/CD, Prisma + Postgres, and Google OAuth"
      ]
    },
    {
    ...
    },
    {
      ...
      tags: ["Python", "LangChain", "LangGraph", "Google Workspace APIs", "Pydantic"],
      github: "https://github.com/harishm17/smart_email",
      featured: true,
      image: "/projects/smart-email-draft.png",
      points: [
        "Built a tool-orchestrated email and calendar copilot that answers questions over inbox and schedule, drafts reply with personalized writing style, and manages calendar events through Google Workspace integration",
        "Built a safety and reliability stack with schema-validated tool outputs, PII redaction, policy checks, and an independent LLM judge; added robust fallbacks and observability for latency and tool failures"
      ]
    },
    {
